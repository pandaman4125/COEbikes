		...
		<template v-if="page.fields">
			...
			<div class="content"
				...
				<dl>
					<dt>Email Us:</dt>
					<dd>
						<a :href="`mailto:${companyInfo.fields.emailAddress}`">{{ companyInfo.fields.emailAddress }}</a>
					</dd>

					<dt>Call Us:</dt>
					<dd>
						<a :href="`tel:${companyInfo.fields.phoneNumber}`">{{ companyInfo.fields.phoneNumber }}</a>
					</dd>
